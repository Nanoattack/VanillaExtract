...
public class JuicerContainer extends Container {
    ...
    public JuicerContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
    ...
    public boolean stillValid(PlayerEntity player) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(),
                tileEntity.getBlockPos()), playerEntity, ModBlocks.JUICER.get());
    }
