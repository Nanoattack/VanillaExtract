...
public class AcaciaLeavesConverterModifier extends LootModifier
{
    private final int countToConvert;
    private final Item itemToCheck;
    private final Item itemReward;

    public AcaciaLeavesConverterModifier(ILootCondition[] conditionsIn, int count, Item itemCheck, Item reward) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<AcaciaLeavesConverterModifier> {

        @Override
        public AcaciaLeavesConverterModifier read(ResourceLocation name, JsonObject object, ILootCondition[] conditionsIn) {
            ...
            Item cashew_apple = ForgeRegistries.ITEMS.getValue(new ResourceLocation(JSONUtils.getAsString(object, "replacement")));
            return new AcaciaLeavesConverterModifier(conditionsIn, count, stick, cashew_apple);
        }

        @Override
        public JsonObject write(AcaciaLeavesConverterModifier instance) {
